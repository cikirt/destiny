<template>
  <section class="timeline-container timeline">
    <div @click="changeCurrentTimePoint(point)" 
       class='timeline-block'
       v-for='point in points' :key='point.title' >
  ...
  <el-dialog title="作品大纲" :visible.sync="dialogFormVisible">
  <el-form :model="form">
    <el-form-item label="题材" :label-width="formLabelWidth">
      <el-input v-model="form.name" auto-complete="off"></el-input>
    </el-form-item>
    <el-form-item label="风格" :label-width="formLabelWidth">
      <el-select v-model="form.region" placeholder="请选择风格">
        <el-option label="风格1" value="shanghai"></el-option>
        <el-option label="风格2" value="beijing"></el-option>
      </el-select>
    </el-form-item>
       <el-form-item label="思想" :label-width="formLabelWidth">
      <el-input v-model="form.name" auto-complete="off"></el-input>
    </el-form-item>
      ...
      <el-form-item label="发展" :label-width="formLabelWidth">
      <el-input v-model="form.name" auto-complete="off"></el-input>
    </el-form-item>
      <el-form-item label="高潮" :label-width="formLabelWidth">
      <el-input v-model="form.name" auto-complete="off"></el-input>
    </el-form-item>
