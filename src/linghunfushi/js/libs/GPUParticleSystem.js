...
THREE.GPUParticleSystem = function ( options ) {
  ...
  this.particleNoiseTex = this.PARTICLE_NOISE_TEXTURE || textureLoader.load( 'http://destiny-1254002014.cosbj.myqcloud.com/perlin-512.png?sign=XsoiyLeYBs8ovBLLJQ8V9iAKjwdhPTEyNTQwMDIwMTQmaz1BS0lENDJwVHdFdDZIR2lPeU1UWk81Qjh1aE1wOXhjQnNqaVYmZT0xNTM1ODA1NzMyJnQ9MTUzMzIxMzczMiZyPTE0ODU2ODMxMzImZj0vcGVybGluLTUxMi5wbmcmYj1kZXN0aW55' );
	this.particleNoiseTex.wrapS = this.particleNoiseTex.wrapT = THREE.RepeatWrapping;

  this.particleSpriteTex = this.PARTICLE_SPRITE_TEXTURE || textureLoader.load( 'http://destiny-1254002014.cosbj.myqcloud.com/particle2.png?sign=ridgw1yLU1NARdPgWsxk+k/CWrphPTEyNTQwMDIwMTQmaz1BS0lENDJwVHdFdDZIR2lPeU1UWk81Qjh1aE1wOXhjQnNqaVYmZT0xNTM1ODA1NzMyJnQ9MTUzMzIxMzczMiZyPTEyNjc2NDMzOTUmZj0vcGFydGljbGUyLnBuZyZiPWRlc3Rpbnk=' );
