  ...
  render () {
      ...
      >
          ...
          >
              ...
              />
              <Svg.Text fontSize="20" fontWeight="bold" fill="blue" textAnchor="middle" x="40" y="80">STAR</Svg.Text>
          </Svg.G>
      </Svg>;
  }
}
...
const icon = <Svg
  ...
  width="20"
>
  <Svg.G strokeWidth="1" stroke="#ccc" fill="#ccc">
      <Svg.Line x1="4" y1="5" x2="16" y2="5" />
      <Svg.Polyline points="6,2 4,5 6,8" />
      <Svg.Line x1="10" y1="1" x2="10" y2="5" />
      <Svg.Polyline points="14,2 16,5 14,8" />
      <Svg.Polyline points="7,3 10,1 13,3" />
  </Svg.G>
  <Svg.Path fill="#fff" stroke="#000" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" d={`M6.2,9.4
